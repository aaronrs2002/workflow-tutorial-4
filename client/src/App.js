      ...
      {isValidUser === false ?
        ...
        <React.Fragment>
          ...
          <div className="container my-5">
            {activeModule === "workflow" ? <WorkFlow showAlert={showAlert} config={config} ticketInfo={ticketInfo} userEmail={userEmail} getTickets={getTickets} /> : null}
            {activeModule === "ticketBuilder" ? <TicketBuilder ticketInfo={ticketInfo} showAlert={showAlert} config={config} userEmail={userEmail} getTickets={getTickets} /> : null}
          </div>
